...
// For class member functions, here we only try with the routine directives in
// the class and the function definitions after the class.  ../routine.cpp
// checks various cases where member function prototypes/definitions/uses appear
// within or after the class.
//
