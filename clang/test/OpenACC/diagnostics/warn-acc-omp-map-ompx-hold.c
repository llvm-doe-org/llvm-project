...
int main() {
  ...
  // error-error@+6  2 {{the OpenACC 'present' clause translation uses the 'ompx_hold' map type modifier}}
  // error-note@+5   2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // error-note@+4   2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  // warn-warning@+3 2 {{the OpenACC 'present' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  #pragma acc data present(x, y) present(z)
  // nomap translation here should not use ompx_hold and so should not warn.
  #pragma acc parallel
  x = 5;
  // warn-warning@+3 {{the OpenACC 'present' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  // warn-warning@+3 2 {{the OpenACC 'copy' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  #pragma acc parallel
  x = 5;
  // warn-warning@+3 {{the OpenACC 'copy' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  // warn-warning@+3 2 {{the OpenACC 'copyin' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  #pragma acc parallel
  x = 5;
  // warn-warning@+3 {{the OpenACC 'copyin' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  // warn-warning@+3 2 {{the OpenACC 'copyout' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  #pragma acc parallel
  x = 5;
  // warn-warning@+3 {{the OpenACC 'copyout' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  // warn-warning@+3 2 {{the OpenACC 'create' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  #pragma acc parallel
  x = 5;
  // warn-warning@+3 {{the OpenACC 'create' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  // warn-warning@+3 2 {{the OpenACC 'no_create' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    2 {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    2 {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
  ...
  #pragma acc parallel
  x = 5;
  // warn-warning@+3 {{the OpenACC 'no_create' clause translation uses the 'ompx_hold' map type modifier}}
  // warn-note@+2    {{an alternative OpenMP translation can be specified with, for example, '-fopenacc-structured-ref-count-omp=no-ompx-hold'}}
  // warn-note@+1    {{or you can just disable this diagnostic with '-Wno-openacc-omp-map-ompx-hold'}}
