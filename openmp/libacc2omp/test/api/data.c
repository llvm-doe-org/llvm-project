...
CASE(caseCopyinExtendsAfter) {
  ...
  //  ERR-caseCopyinExtendsAfter-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseCopyinExtendsBefore) {
  ...
  //  ERR-caseCopyinExtendsBefore-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseCopyinSubsumes) {
  ...
  //  ERR-caseCopyinSubsumes-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseCreateExtendsAfter) {
  ...
  //  ERR-caseCreateExtendsAfter-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseCreateExtendsBefore) {
  ...
  //  ERR-caseCreateExtendsBefore-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseCreateSubsumes) {
  ...
  //  ERR-caseCreateSubsumes-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateDeviceAbsent) {
  ...
  //  ERR-caseUpdateDeviceAbsent-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateDeviceExtendsAfter) {
  ...
  //  ERR-caseUpdateDeviceExtendsAfter-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateDeviceExtendsBefore) {
  ...
  //  ERR-caseUpdateDeviceExtendsBefore-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateDeviceSubsumes) {
  ...
  //  ERR-caseUpdateDeviceSubsumes-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateSelfAbsent) {
  ...
  //  ERR-caseUpdateSelfAbsent-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateSelfExtendsAfter) {
  ...
  //  ERR-caseUpdateSelfExtendsAfter-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateSelfExtendsBefore) {
  ...
  //  ERR-caseUpdateSelfExtendsBefore-OFF-NEXT: Libomptarget error: Consult {{.*}}
...
CASE(caseUpdateSelfSubsumes) {
  ...
  //  ERR-caseUpdateSelfSubsumes-OFF-NEXT: Libomptarget error: Consult {{.*}}
