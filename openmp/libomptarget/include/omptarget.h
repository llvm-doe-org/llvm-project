...
enum tgt_map_type {
  ...
  OMP_TGT_MAPTYPE_OMPX_NO_ALLOC   = 0x4000,
...
void *omp_get_mapped_hostptr(const void *Ptr, int DeviceNum);
size_t omp_get_accessible_buffer(const void *Ptr, size_t Size, int DeviceNum,
                                 void **BufferHost, void **BufferDevice);
void *omp_target_map_to(void *Ptr, size_t Size, int DeviceNum);
void omp_target_map_from(void *Ptr, size_t Size, int DeviceNum);
void omp_target_map_from_delete(void *Ptr, size_t Size, int DeviceNum);
void *omp_target_map_alloc(void *Ptr, size_t Size, int DeviceNum);
void omp_target_map_release(void *Ptr, size_t Size, int DeviceNum);
void omp_target_map_delete(void *Ptr, size_t Size, int DeviceNum);
void omp_target_update_to(void *Ptr, size_t Size, int DeviceNum);
void omp_target_update_from(void *Ptr, size_t Size, int DeviceNum);
