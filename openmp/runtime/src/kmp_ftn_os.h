...
#define FTN_TARGET_MAP_TO omp_target_map_to
#define FTN_TARGET_MAP_ALLOC omp_target_map_alloc
#define FTN_TARGET_MAP_FROM omp_target_map_from
...
#define FTN_TARGET_MAP_TO omp_target_map_to_
#define FTN_TARGET_MAP_ALLOC omp_target_map_alloc_
#define FTN_TARGET_MAP_FROM omp_target_map_from_
